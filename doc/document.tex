...
\input{content/1_konzept.tex}
\input{content/2_repraesentation.tex}
\input{content/3_operatoren.tex}
%\input{content/4_selektionsdruck.tex}
%\input{content/5_guetebewertung.tex}
\input{content/6_simulation.tex}
%\input{content/7_effizienz.tex}
\input{content/8_fazit.tex}
